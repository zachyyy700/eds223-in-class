...
#? What's the difference between crop & mask again?
# Crop "crops" to extent. Mask sets values outside of SB boundary to NA.
...
```{r}
# Compare supervised vs unsupervised plots
